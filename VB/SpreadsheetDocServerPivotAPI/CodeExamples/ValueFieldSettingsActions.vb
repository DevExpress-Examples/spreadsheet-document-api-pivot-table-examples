...
Namespace SpreadsheetDocServerPivotAPI
	Public Module ValueFieldSettingsActions
		Public ChangeSummaryFunctionAction As Action(Of Workbook) = AddressOf ChangeSummaryFunction
		Public DifferenceFromAction As Action(Of Workbook) = AddressOf DifferenceFrom
		Public PercentOfAction As Action(Of Workbook) = AddressOf PercentOf
		Public PercentOfParentRowTotalAction As Action(Of Workbook) = AddressOf PercentOfParentRowTotal
		Public RankLargestToSmallestAction As Action(Of Workbook) = AddressOf RankLargestToSmallest
		Public RunningTotalInAction As Action(Of Workbook) = AddressOf RunningTotalIn
		Public NumberFormatAction As Action(Of Workbook) = AddressOf NumberFormat

		Private Sub ChangeSummaryFunction(ByVal workbook As IWorkbook)
...
#End Region ' #ChangeSummaryFunction
		...
		Private Sub DifferenceFrom(ByVal workbook As IWorkbook)
...
#End Region ' #DifferenceFrom
		...
		Private Sub PercentOf(ByVal workbook As IWorkbook)
#Region "#PercentOf"
			Dim worksheet As Worksheet = workbook.Worksheets("Report14")
			workbook.Worksheets.ActiveWorksheet = worksheet
...
#End Region ' #PercentOf
		...
		Private Sub PercentOfParentRowTotal(ByVal workbook As IWorkbook)
...
#End Region ' #PercentOfParentRowTotal
		...
		Private Sub RankLargestToSmallest(ByVal workbook As IWorkbook)
...
#End Region ' #RankLargestToSmallest
		...
		Private Sub RunningTotalIn(ByVal workbook As IWorkbook)
...
#End Region ' #RunningTotalIn
		...
		Private Sub NumberFormat(ByVal workbook As IWorkbook)
#Region "#NumberFormat"
			Dim sourceWorksheet As Worksheet = workbook.Worksheets("Data5")
			Dim worksheet As Worksheet = workbook.Worksheets.Add()
			workbook.Worksheets.ActiveWorksheet = worksheet
