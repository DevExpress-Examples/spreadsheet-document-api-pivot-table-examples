...
Namespace SpreadsheetDocServerPivotAPI
	Friend Class PivotCalculatedFieldActions
		...
		Public Shared AddCalculatedFieldAction As Action(Of Workbook) = AddressOf AddCalculatedField
		Public Shared RemoveCalculatedFieldAction As Action(Of Workbook) = AddressOf RemoveCalculatedField
		Public Shared ModifyCalculatedFieldAction As Action(Of Workbook) = AddressOf ModifyCalculatedField
