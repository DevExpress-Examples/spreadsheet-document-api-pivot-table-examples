...
Namespace SpreadsheetDocServerPivotAPI
	Friend Class PivotFieldGroupingActions
		Public Shared GroupFieldItemsAction As Action(Of Workbook) = AddressOf GroupFieldItems
		Public Shared GroupFieldByDatesAction As Action(Of Workbook) = AddressOf GroupFieldByDates
		Public Shared UngroupSpecificItemAction As Action(Of Workbook) = AddressOf UngroupSpecificItem
		Public Shared UngroupFieldItemsAction As Action(Of Workbook) = AddressOf UngroupFieldItems
